...
public class account {
    ...
    public int checkingWithdrawFund(int amt){
        //int amt=0;
    ...
    public int savingWithdrawFund(int amt){
        //int amt=0;
        //System.out.println("Enter the withdraw amount: ");
        //amt=input.nextInt();
    ...
    public int checkingDepositFund(int amt){
        //int amt=0;
        //System.out.println("Enter the deposit amount: ");
        //amt=input.nextInt();
        return checkBalance=checkBalance+amt;
    }
    public int savingsDepositFund(int amt){
        //int amt=0;
        //System.out.println("Enter the deposit amount: ");
        //amt=input.nextInt();
        return savingsBalance=savingsBalance+amt;
